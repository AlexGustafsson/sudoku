<template>
  <div class="cell" v-bind:class="{hasNumber: number, selected: selected, highlit: highlit, secondary: secondarySelected, hasHighlitMark: hasHighlitMark, crossedCell: crossed}" v-on:click="clicked">
